...
new_temp = "90" 
processed_list = ["git_repo_1" , "123", "git_repo_2", "456" , "git_repo_3" ,"789" ]
...
while True:
    ...
    #out = out.split()[0]         
    """
    if(commit_id_from_repo_1 in commit_list):
        if(commit_id_from_1 in processed_list):
            
    elif(commit_id_from_repo_1 in processed_list):
        time.sleep(60)
    else:
